      ...
      <div className="about-videos-navigate-container1">
        <div className="about-video-navigate">
          ...
          <div className="about-videos-navigate-description">
            Study at <span> HIGHLAND </span> for a promised bright future
          </div>
      ...
      <section id="admission">
        <div className="admission-fees-structure">
          <div className="aboutus-details-title">
            <div className="aboutus-details-title-img">
              {" "}
              <img src={tiltle} alt="" />
            </div>
        ...
        <div className="application-description-container">
          <div className="application-description">
            We are delighted that you have chosen to apply to Highland School.
            Highland utilizes the SchoolAdmin application and enrollment portal.
            The general process consists of the following steps.
          </div>
        </div>
        <div className="application-process-container">
          <div className="application-process-title">Application Process</div>
          <div className="application-process-description">
            ...
            <div className="application-process-container">
              ...
              <div className="application-process-container-label">
                Choose Level
              </div>
              <div className="application-process-container-desc">
                Choose which level you want to enroll your child in and then
                follow to the next part of the procedure.
              </div>
            </div>
            ...
            <div className="application-process-container">
              ...
              <div className="application-process-container-desc">
                ...
                requirements for certain levels.
              </div>
            </div>
            {/* the application process one end   */}
            ...
            <div className="application-process-container">
              ...
              <div className="application-process-container-desc">
                For the procedure to take place, there is a ceratin amount of
                fee you pay. Download the requirements to see the amount.
              </div>
            </div>
            {/* the application process one end   */}
            ...
            <div className="application-process-container">
              ...
              <div className="application-process-container-desc">
                Then to finish register your child and you are all done.
              </div>
            </div>
            {/* the application process one end   */}
          </div>
        ...
        <div className="information-container">
          <div className="application-process-title">For more info.......</div>
          ...
          {meet ? (
            <Meeting canceling={meeting} name={name} contact={contact} />
          ) : (
            ""
          )}
        </div>
